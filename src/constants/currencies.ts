import type { Currency, ChartPeriodOption } from '../types';

// Chart Time Periods
export const CHART_TIME_PERIODS: ChartPeriodOption[] = [
  ...
  { value: '30y', label: '30 Years', days: 10950 },
];
...
export const ALL_CURRENCIES: Currency[] = [
  ...
  { code: 'SLL', name: 'Sierra Leonean Leone (pre-2022)', symbol: 'Le' },
  { code: 'SOS', name: 'Somali Shilling', symbol: 'S' },
  { code: 'SRD', name: 'Surinamese Dollar', symbol: '$' },
  { code: 'STD', name: 'São Tomé and Príncipe Dobra (pre-2018)', symbol: 'Db' },
...
export const API_BASE_URL = 'https://api.exchangerate-api.com/v4';
export const FREE_API_URL = 'https://api.exchangerate-api.com/v4/latest'; // Real API without key
